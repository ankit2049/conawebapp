            ...
            <div className={classes.root}>
                <Paper elevation={0} className={classes.paper}>
                    <Breadcrumbs aria-label="Breadcrumb" className={classes.breadcrumbs}>
                        ...
                        <Typography color="Primary">PUNE APARTMENT</Typography>
                    ...
                    <Card className={classes.card}>
                        <CardContent>
                            <div className={classes.typoflex}>
                                <Whatshot  style={{ color: '#FFB400', flexGrow: 1, justifyContent:'left' }}/>
                ...
                <div className={classes.flexContainer}>
                    <RoomsCard cardTitle="LIVING ROOM"/>
                    <RoomsCard cardTitle="BEDROOM" />
                    <RoomsCard cardTitle="KITCHEN" />
                    <RoomsCard cardTitle="DINING ROOM" />
                </div>
